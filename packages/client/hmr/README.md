...
- **Document navigation of `/plugins/events` is 406** — the channel answers only `Accept: text/event-stream`. A browser GET without that header must not hang on the endless SSE body.
