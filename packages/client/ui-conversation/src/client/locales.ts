...
export const zh = {
  ...
  'message.edit': '编辑',
  'message.edit.title': '重新编辑这条消息？',
  'message.edit.description': '当前对话会撤回到这条消息之前，并把原文放入输入框。这条消息及其后的回复会从当前对话中收起；已经对文件或环境做过的修改不会自动撤销。',
  'message.edit.confirm': '继续编辑',
...
export const en = {
  ...
  'message.edit': 'Edit',
  'message.edit.title': 'Edit this message?',
  'message.edit.description': 'This rewinds the current conversation to before this message and puts the original text in the composer. This message and what followed leave the current conversation. Changes already made to files or the environment are not undone.',
  'message.edit.confirm': 'Continue editing',
